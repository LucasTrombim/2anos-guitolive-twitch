...
export default function CorridaGame() {
  const car1 = '/images/Carro Rosa.svg';
  const car2 = '/images/Carro Roxo.svg';
  ...
  return (
    <>
      ...
      <div id="car1" className="absolute bottom-40 left-10">
        <img src={car1} alt="" className="" />
      </div>
      <div id="car2" className="absolute bottom-0 left-10">
